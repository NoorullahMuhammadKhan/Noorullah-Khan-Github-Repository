...
# Reorder columns
df = df[['TimeAsCustomer', 'DriverAge', 'InsuranceAccess', 'InsurancePremium', 'DriverGender', 'EducationLevel', 'AccidentType', 'IncidentSeverity', 'AuthoritiesInvolved', 'IncidentTime', 'NumVehiclesInvolved', 'NumBodilyInjuries', 'PoliceReportBool', 'TotalClaimAmount', 'ClaimStatus', 'VehicleAge', 'DriverExperience', 'LicenceType']]
